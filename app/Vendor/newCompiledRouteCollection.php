...
class newCompiledRouteCollection extends AbstractRouteCollection
{
    /**
    ...
    {
        $attributes = collect($this->attributes)->first(function (array $attr) use ($action) {
            return $attr['action']['controller'] === $action;
        });
