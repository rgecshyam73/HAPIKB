...
class BonusReferralRequest extends APIRequest
{
    /**
...
,        ];
    ...
    private function isValidHash()
    {
        ...
        return $this->hash == hash('sha256', $this->operatorid . $this->username . $this->start_date . $this->end_date . $this->status . $secret_key);
    }
